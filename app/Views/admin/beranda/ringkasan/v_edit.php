...
<div class="main-content">
    <section class="section">
        ...
        <form method="POST" action="<?= base_url('C_dashboard/ringkasan_saveedit/' . $data['id']) ?>" class="needs-validation" novalidate="" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Edit Ringkasan</h4>
                        </div>
                        <div class="card-body">
